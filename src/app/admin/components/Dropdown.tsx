...
export default function Dropdown({ title, children, align = 'right' }: { title: string, children: React.ReactNode, align?: 'left' | 'right' }) {
  return (
